...
GTFO.SpellID["37106"] = {
    --desc = "Charged Arcane Explosion (Crystalcore Sentinel)";
    sound = 3;
};
...
GTFO.SpellID["47251"] = {
    --desc = "Flame Breath (Sunblade Dragonhawk)";
    sound = 3;
    tankSound = 0;
};

GTFO.SpellID["46559"] = {
    --desc = "Cleave (Sunblade Vindicator)";
    sound = 3;
    tankSound = 0;
};

GTFO.SpellID["44799"] = {
    --desc = "Frost Breath (Kalecgos)";
    sound = 3;
    tankSound = 0;
};

GTFO.SpellID["45717"] = {
    --desc = "Fog of Corruption (Felmyst)";
    sound = 3;
};

GTFO.SpellID["46292"] = {
    --desc = "Cataclysm Breath (Cataclysm Hound)";
    sound = 3;
    tankSound = 0;
};

GTFO.SpellID["45885"] = {
    --desc = "Shadow Spike (Kil'jaeden)";
    sound = 3;
};
